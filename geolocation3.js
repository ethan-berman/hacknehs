  ...
  function codeAddress(address) {
    ...
    geocoder.geocode( { 'address': address}, function(results, status) {
      ...
      lng1=results[0].geometry.location.lng()
       ...
       waypoint0: results[0].geometry.location.lat().toString() +", "+results[0].geometry.location.lng().toString(),
       waypoint1: results[0].geometry.location.lat().toString() + ", "  + results[0].geometry.location.lng().toString()
